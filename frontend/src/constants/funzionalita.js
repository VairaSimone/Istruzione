...
export const DIPENDENZE = Object.freeze({
  ...
  [FUNZIONALITA.CHAT_AULA]: [FUNZIONALITA.AULE],
...
export const ROUTE_PER_FUNZIONALITA = Object.freeze({
  ...
  [FUNZIONALITA.CHAT_AULA]: [ROUTES.CHAT, ROUTES.CHAT_AULA],
  ...
  [FUNZIONALITA.PAGAMENTI]: [
    ROUTES.CATALOGO,
    ROUTES.PAGAMENTO_ESITO,
    ROUTES.SCUOLA_PAGAMENTI,
  ],
});
